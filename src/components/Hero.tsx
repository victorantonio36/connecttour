        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex justify-center mb-8 animate-fade-in">
            <div className="relative">
              <img
                src={angolaConnectourLogo}
                alt="Angola ConnecTour"
                className="h-24 md:h-32 lg:h-40 w-auto object-contain drop-shadow-[0_4px_20px_rgba(0,0,0,0.2)]"
                style={{
                  filter: "drop-shadow(0 4px 20px rgba(47, 119, 120, 0.3))",
                }}
              />
          ...
          {/* Title */}
          <h1 
            className="text-5xl md:text-7xl font-bold text-white text-balance leading-tight animate-fade-in-up"
            style={{
          ...
          {/* Subtitle */}
          <p 
            className="text-xl md:text-2xl text-white/90 max-w-2xl mx-auto text-balance animate-fade-in-up"
            style={{
          ...
          >
            <Button
              size="lg"
              className="bg-connectour-golden hover:bg-connectour-golden/90 text-connectour-deep border-0 font-semibold transition-all duration-300 hover:scale-105 hover:shadow-[0_8px_30px_rgba(227,206,170,0.4)] group gap-2"
              onClick={() => {
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-2 border-white/40 bg-white/10 backdrop-blur-md text-white hover:bg-white/20 hover:border-white/60 transition-all duration-300 hover:scale-105 gap-2"
